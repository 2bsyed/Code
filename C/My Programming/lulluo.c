...
int main()
{
      ...
      if (choice==1){printf("\nThe rules are simple: \n (1)You press enter to roll the dice\n (2)You are then told which space you have landed on\n (3)If you land on a snake you will move down the board\n (4)If you land on a ladder then you will move up it\n (5)In order to win you must land on 64 exactly\n (6)If you go over 64 then your imaginary piece will be moved backwards for the remainder of your dice roll\n\n **Good Luck**\n\n");
                      }
      if (choice==1,2){
